...
Verified via grep: items #1, #2, #3 are implemented. Items #4–#10 are still pending. For every remaining item we follow the existing testing + WCAG conventions you've already established:
