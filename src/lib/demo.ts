...
const DEMO_ENTRIES: LexisEntry[] = [
  ...
  { id: "demo-8", danish: "tak", english: "thanks", notes: "Very common", type: "word", createdAt: h(8) },
  { id: "demo-9", danish: "undskyld", english: "sorry/excuse me", notes: "", type: "word", createdAt: h(9) },
  { id: "demo-10", danish: "det er lige meget", english: "it doesn't matter", notes: "", type: "expression", createdAt: h(10) },
  { id: "demo-11", danish: "at have det sjovt", english: "to have fun", notes: "", type: "expression", createdAt: h(11) },
